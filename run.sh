...
function generate-project {
    ...
    git add --all
    git branch -M main
    git commit -m "feat: generated sample project with python-course-cookiecutter"
}
...
EOF
    ...
    if [[ -n "$GH_TOKEN" ]]; then
        git remote set-url origin "https://$GITHUB_USERNAME:$GH_TOKEN@github.com/$REPO_NAME"
    fi
